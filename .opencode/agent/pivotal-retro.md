---
description: Retrospective agent - extracts learnings from completed milestone epics
mode: subagent
...
```bash
# Use contains-learnings label for efficient filtering:
...
bd list --parent <epic-id> --status closed --label contains-learnings --json
